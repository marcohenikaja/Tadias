...
// import { Row, Col, Card, Typography, Grid, Spin, Alert, Button, Tag, DatePicker, Space, Divider } from 'antd';
...
//   // ✅ fetch avec param month + cache par mois
//   const fetchTresorerie = useCallback(async (mStr, retryCount = 0) => {
//     const controller = new AbortController();
//     let timeoutId;

//     const cacheKey = `tresorerie_cache_${mStr}`;
...
//       const url = `${API_BASE}/api/tresorerie?month=${encodeURIComponent(mStr)}`;
...
//           </Title>
//           <Text type="secondary">
//             Mois sélectionné : <b>{selectedMonth.format('MMMM YYYY')}</b> • Solde ouverture • Cumul année • Prévision 30 jours
//           </Text>
//         </div>
...
//       {/* ✅ KPI cards : ouverture + mois + solde */}
//       <Row gutter={[isMobile ? 16 : 24, isMobile ? 16 : 24]} style={{ marginBottom: 16 }}>
//         <Col xs={24} md={8}>
//           <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.10),0 0 1px rgba(15,23,42,0.08)' }}>
//             <Text type="secondary">Solde ouverture (année)</Text>
...
//             <Text type="secondary" style={{ fontSize: 12 }}>Ligne “SOLDE OUVERTURE …” importée</Text>
//           </Card>
//         </Col>

//         <Col xs={24} md={8}>
//           <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.10),0 0 1px rgba(15,23,42,0.08)' }}>
//             <Text type="secondary">Net du mois</Text>
...
//                 <Text type="secondary">Encaissements (CA)</Text>
//                 <Text strong>{formatAr(derived.encaissements)}</Text>
//               </div>
//               <div style={{ display: 'flex', justifyContent: 'space-between' }}>
//                 <Text type="secondary">Décaissements (Charges)</Text>
...
//         <Col xs={24} md={8}>
//           <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.10),0 0 1px rgba(15,23,42,0.08)' }}>
//             <Text type="secondary">Solde actuel (cumul année)</Text>
//             <div
//               style={{
//                 fontSize: 28,
//                 fontWeight: 900,
//                 marginTop: 8,
//                 color: soldeNegatif ? '#ff4d4f' : '#52c41a',
//               }}
//             >
...
//           <Card
//             bordered={false}
//             style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.12),0 0 1px rgba(15,23,42,0.08)' }}
//           >
//             <Title level={5} style={{ marginBottom: 4 }}>
//               Évolution du cash (6 mois)
//             </Title>
//             <Text type="secondary" style={{ fontSize: 12 }}>
//               Cumul depuis janvier (solde ouverture inclus)
//             </Text>
...
//                   <YAxis width={90} tickLine={false} axisLine={false} tickMargin={8} allowDecimals={false} tickFormatter={formatArAxis} />
...
//                 <Text type="secondary">Aucun décaissement trouvé.</Text>
//               ) : (
...
//                       alignItems: 'center',
//                       padding: '10px 0',
//                       borderBottom: index === derived.topDecaissements.length - 1 ? 'none' : '1px solid rgba(0,0,0,0.05)',
//                       gap: 12,
//                     }}
//                   >
...
export default function Tresorerie() {
  ...
  return (
    <div style={{ padding: isMobile ? 8 : 24 }}>
      ...
      <Row gutter={[isMobile ? 16 : 24, isMobile ? 16 : 24]} style={{ marginBottom: 16 }}>
        <Col xs={24} md={8}>
          <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.10),0 0 1px rgba(15,23,42,0.08)', background: 'radial-gradient(circle at 0% 0%, #074a73ff 0, #8bcdd7ff 55%, #1fa6c1ff 100%)', color: '#fff' }}>
            <Text type="secondary" style={{ margin: '8px 0 0', color: '#fff' }}>Solde ouverture ({isGlobal ? 'début historique' : 'année'})</Text>
        ...
        <Col xs={24} md={8}>
          <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.10),0 0 1px rgba(15,23,42,0.08)' }}>
            <Text type="secondary">{isGlobal ? 'Net global' : 'Net du mois'}</Text>
            <Title level={3} style={{ margin: '8px 0 0', color: netNegatif ? '#ff4d4f' : '#52c41a' }}>
              {formatAr(derived.netMois)}
            </Title>
            ...
            <Space direction="vertical" size={2} style={{ width: '100%' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <Text type="secondary">Encaissements</Text>
                <Text strong>{formatAr(derived.encaissements)}</Text>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <Text type="secondary">Décaissements</Text>
                <Text strong style={{ color: '#f5222d' }}>-{formatAr(derived.decaissements)}</Text>
              </div>
            </Space>
          </Card>
        ...
        <Col xs={24} md={8}>
          <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.10),0 0 1px rgba(15,23,42,0.08)', background: 'radial-gradient(circle at 0% 0%, #074a73ff 0, #8bcdd7ff 55%, #1fa6c1ff 100%)', color: '#fff' }}>
            <Text type="secondary" style={{ color: '#fff' }}>Solde actuel (cumul {isGlobal ? 'global' : 'année'})</Text>
      ...
      <Row gutter={[isMobile ? 16 : 24, isMobile ? 16 : 24]}>
        ...
        <Col xs={24} md={12}>
          <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.12),0 0 1px rgba(15,23,42,0.08)' }}>
            <Title level={5} style={{ marginBottom: 4 }}>Évolution du cash (6 mois)</Title>
            <Text type="secondary" style={{ fontSize: 12 }}>
        ...
        <Col xs={24} md={12}>
          <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.12),0 0 1px rgba(15,23,42,0.08)' }}>
            <Title level={5} style={{ marginBottom: 4 }}>Prévision light (30 jours)</Title>
            <Text type="secondary" style={{ fontSize: 12 }}>
              {isGlobal ? 'Basée sur la moyenne des 30 derniers jours (estimatif)' : 'Basée sur le rythme moyen du mois sélectionné (estimatif)'}
            </Text>
        ...
        <Col span={24}>
          <Card bordered={false} style={{ borderRadius: 20, boxShadow: '0 18px 45px rgba(15,23,42,0.12),0 0 1px rgba(15,23,42,0.08)' }}>
            <Title level={5} style={{ marginBottom: 4 }}>Plus gros décaissements</Title>
            <Text type="secondary" style={{ fontSize: 12 }}>
              ACH (débits) • Selon échéance si dispo, sinon date
            </Text>
