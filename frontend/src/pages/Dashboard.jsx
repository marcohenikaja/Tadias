...
// /**
//  * ✅ FuelGaugeCar (design “jauge voiture” + miroir décaissement)
//  */
...
//   if (!idRef.current) idRef.current = `fuel_${Math.random().toString(36).slice(2)}_${Date.now()}`;
...
//     if (count === 4) return [maxUsed, min + ((maxUsed - min) * 2) / 3, min + ((maxUsed - min) * 1) / 3, min];
//     return [
//       maxUsed,
//       min + ((maxUsed - min) * 3) / 4,
//       min + ((maxUsed - min) * 1) / 2,
...
//         <div style={{ color: 'rgba(255,255,255,0.70)', fontSize: 11, marginTop: 3 }}>{stateText}</div>
//       </div>
//     </div>
//   );
// }
...
//   const fillColor = tone === 'danger' ? '#ff4d4f' : tone === 'warn' ? '#faad14' : '#52c41a';
//   const borderColor =
//     tone === 'danger'
//       ? 'rgba(255,77,79,0.55)'
//       : tone === 'warn'
//         ? 'rgba(250,173,20,0.55)'
//         : 'rgba(82,196,26,0.50)';

//   const stateText =
//     negatif ? 'Cash négatif' : cashPct < 20 ? 'Réserve très basse' : cashPct < 40 ? 'Réserve basse' : 'Cash OK';
...
//   // ✅ CHOIX DESIGN
//   // Enc/Dec : "dial" (DarkDialGauge) ou "car" (FuelGaugeCar)
//   const [flowDesign, setFlowDesign] = useState('car');
//   const [cashDesign, setCashDesign] = useState('fuel');
...
//   // ✅ options des boutons
//   const flowDesignOptions = isMobile
//     ? [
//       { label: 'Cadran', value: 'dial' },
//       { label: 'Voiture', value: 'car' },
//     ]
//     : [
//       { label: 'Enc/Dec: Cadran', value: 'dial' },
//       { label: 'Enc/Dec: Jauge voiture', value: 'car' },
//     ];

//   const cashDesignOptions = isMobile
//     ? [
//       { label: 'Cadran', value: 'dial' },
//       { label: 'Jauge', value: 'fuel' },
//     ]
//     : [
//       { label: 'CASH: Cadran', value: 'dial' },
//       { label: 'CASH: Jauge', value: 'fuel' },
//     ];

//   // CASH en cadran : on affiche l’absolu (aiguille propre), mais le texte garde le signe
//   const cashDialValue = Math.max(0, Math.abs(Number(derived.cashDisponible || 0)));
//   const cashDialColor = cashNegatif ? '#ff4d4f' : cashPct < 20 ? '#faad14' : '#52c41a';
...
//                 <div>
//                   <Text type="secondary" style={{ fontSize: 12, color: '#fff' }}>Alertes</Text>
//                   <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
...
//                 <Segmented
//                   value={flowDesign}
//                   onChange={setFlowDesign}
//                   options={flowDesignOptions}
//                   style={{
...
//                 <Segmented
//                   value={cashDesign}
//                   onChange={setCashDesign}
//                   options={cashDesignOptions}
//                   style={{
//                     background: 'rgba(255,255,255,0.10)',
//                     color: '#fff',
//                   }}
//                 />
//               </Space>
//               <Segmented value={alertFilter} onChange={setAlertFilter} options={alertOptions} style={{ color: '#fff', width: isMobile ? '100%' : 'auto' }} />
...
//                           <Text strong style={{ fontSize: 12, color: '#fff' }}>{a.title}</Text>
//                           <Badge count={a.level === 'red' ? '!' : ''} style={{ backgroundColor: c }} />
//                         </Space>
//                         <Text type="secondary" style={{ fontSize: 11, color: '#fff' }}>{a.message}</Text>
//                       </Space>
//                     </List.Item>
//                   );
//                 }}
...
//                   {/* CASH (selon cashDesign) + miniscreens */}
//                   <div>
...
//                             value={cashDialValue}
//                             max="auto"
//                             size={isMobile ? 270 : 300}
//                             bottomValue={formatMontantSigned(derived.cashDisponible)}

//                             blueGlow
//                             labelMode="auto"
//                             accentColor={cashDialColor}
//                             needleColor={cashDialColor}
//                             subtitle={
//                               <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
//                                 Cash estimé
//                                 <AntTooltip title="Ce montant est une estimation basée sur les données comptables disponibles dans le système. Il ne correspond pas nécessairement au solde bancaire réel et dépend de la qualité et de l'actualisation des données saisies">
...
//         <Col xs={24} lg={8}>
//           <Card bordered={false} style={cardSoft}>
//             <Text type="secondary" style={{ fontSize: 12 }}>Résultat brut estimé</Text>
